...
import { Box, Text, Image, Center, VStack, HStack } from 'native-base';
...
const Bracket: React.FC<BracketProps> = ({
    ...
    return (
        <ScrollView>
            <HStack background={"#444"}>
                <Center flex={1} py={4} px={2} background={"#ff0000"}>
                    <Text color="white" fontSize="md">Chaveamento</Text>
