...
import { Box, VStack, Text, HStack, Image, FlatList } from 'native-base';
...
export function PontosCorridosComponent(props: FaseDeGrupos) {
    ...
    return (
        <Box >
            ...
            <VStack bgColor={'#FFF'} w={'360px'} h={'100%'} borderRadius={'5px'} paddingLeft={4}>
                <HStack paddingTop={4}>
                    <Box w={'50%'}>
